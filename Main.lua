...
function akdo:createFrame(titleText)
	...
	function TabsAndStyles:addTab(name)
		...
		function EI:addFrameButton(name, Info)
			...
			for _,item in pairs(ButtonContent:GetChildren()) do
				item.Parent = ButtonFrame
			end
			...
			function FBE:addButton(name, Info, callback)
				...
				local ButtonFrame = Instance.new("Frame")
				ButtonFrame.Parent = ButtonContent
				ButtonFrame.BackgroundColor3 = akdo.Setting.Properties.ButtonColor
				ButtonFrame.Size = akdo.Setting.Properties.ButtonSize
				addCorner(ButtonFrame, akdo.Setting.ElementCorner)
			...
			function FBE:addToggle(name, Info, callback)
				local TF = {}
				local callback = callback or function() end
				...
				ToggleFrame.Parent = ButtonContent
			...
			function FBE:addDropdown(name, Info, items, itemsPerRow, callback)
				...
				DropdownFrame.Parent = ButtonContent
			...
			function FBE:addSlider(name, Info, BeginValue, Min, Max, callback, GetMode, TextBoxDisable)
				...
				SliderTFrame.Parent = ButtonContent
			...
			function FBE:addTextBox(name, Info, placeholderText, callback, stat, onlyNumbers, onlyLetters)
				...
				TextBoxFrame.Parent = ButtonContent
			...
			function FBE:addRow(FramePerRow, lines)
				...
				function REI:addToggle(name, Info, callback)
					local TF = {}
					local callback = callback or function() end
					local ToggleFrame = Instance.new("Frame")
					local TextButton = Instance.new("TextButton")
